...
An app which keeps track of the movies and TV series I've watched or would like to watch.
...
(I watch a lot of movies). So I've decided to create an app so that the list can be more structured and so that I can
