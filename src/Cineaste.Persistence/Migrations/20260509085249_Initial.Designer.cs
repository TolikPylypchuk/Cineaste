...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.LimitedSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RottenTomatoesSubId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Period", "Cineaste.Core.Domain.LimitedSeries.Period#ReleasePeriod", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.Property<int>("EpisodeCount")
                                .HasColumnType("int")
                                .HasColumnName("EpisodeCount");

                            b1.Property<bool>("IsSingleDayRelease")
                                .HasColumnType("bit")
                                .HasColumnName("IsSingleDayRelease");
                    ...
                    b.ToTable("LimitedSeries", t =>
                        {
                            t.HasCheckConstraint("CH__EndMonthValid", "[StartMonth] >= 1 AND [StartMonth] <= 12");

                            t.HasCheckConstraint("CH__EndYearPositive", "[EndYear] > 0");

                            t.HasCheckConstraint("CH__EpisodeCountPositive", "[EpisodeCount] > 0");

                            t.HasCheckConstraint("CH__PeriodValid", "DATEFROMPARTS([StartYear], [StartMonth], 1) <= DATEFROMPARTS([EndYear], [EndMonth], 1)");

                            t.HasCheckConstraint("CH__StartMonthValid", "[StartMonth] >= 1 AND [StartMonth] <= 12");

                            t.HasCheckConstraint("CH__StartYearPositive", "[StartYear] > 0");
                        });
                });
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.LimitedSeriesPoster", b =>
                {
                    ...
                    b.ToTable("LimitedSeriesPosters", t =>
                        {
                            t.HasCheckConstraint("CH_LimitedSeriesPosters_ContentTypeNotEmpty", "[ContentType] <> ''");

                            t.HasCheckConstraint("CH_LimitedSeriesPosters_DataNotEmpty", "DATALENGTH([Data]) > 0");
                        });
                });
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.ListItem", b =>
                {
                    ...
                    b.HasIndex("LimitedSeriesId")
                        .IsUnique()
                        .HasFilter("[LimitedSeriesId] IS NOT NULL");
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.SeasonPart", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Period", "Cineaste.Core.Domain.SeasonPart.Period#ReleasePeriod", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ToTable("SeasonPeriods", t =>
                        {
                            t.HasCheckConstraint("CH__EndMonthValid", "[StartMonth] >= 1 AND [StartMonth] <= 12")
                                .HasName("CH__EndMonthValid1");

                            t.HasCheckConstraint("CH__EndYearPositive", "[EndYear] > 0")
                                .HasName("CH__EndYearPositive1");

                            t.HasCheckConstraint("CH__EpisodeCountPositive", "[EpisodeCount] > 0")
                                .HasName("CH__EpisodeCountPositive1");

                            t.HasCheckConstraint("CH__PeriodValid", "DATEFROMPARTS([StartYear], [StartMonth], 1) <= DATEFROMPARTS([EndYear], [EndMonth], 1)")
                                .HasName("CH__PeriodValid1");

                            t.HasCheckConstraint("CH__StartMonthValid", "[StartMonth] >= 1 AND [StartMonth] <= 12")
                                .HasName("CH__StartMonthValid1");

                            t.HasCheckConstraint("CH__StartYearPositive", "[StartYear] > 0")
                                .HasName("CH__StartYearPositive1");
                        });
                });
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.SeasonPoster", b =>
                {
                    ...
                    b.Property<Guid>("SeasonPartId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("SeasonPartId");
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.LimitedSeries", b =>
                {
                    b.HasOne("Cineaste.Core.Domain.FranchiseItem", "FranchiseItem")
                        .WithOne("LimitedSeries")
                        .HasForeignKey("Cineaste.Core.Domain.LimitedSeries", "FranchiseItemId");
                    ...
                    b.OwnsMany("Cineaste.Core.Domain.Title", "AllTitles", b1 =>
                        {
                            b1.Property<Guid>("LimitedSeriesId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("LimitedSeriesId", "Id");

                            b1.ToTable("LimitedSeriesTitles", null, t =>
                                {
                                    t.HasCheckConstraint("CH_LimitedSeriesTitles_NameNotEmpty", "[Name] <> ''");

                                    t.HasCheckConstraint("CH_LimitedSeriesTitles_SequenceNumberPositive", "[SequenceNumber] > 0");
                                });
                    ...
                    b.OwnsMany("Cineaste.Core.Domain.TagContainer", "Tags", b1 =>
                        {
                            ...
                            b1.ToTable("LimitedSeriesTags", (string)null);
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.ListItem", b =>
                {
                    ...
                    b.HasOne("Cineaste.Core.Domain.LimitedSeries", "LimitedSeries")
                        .WithOne("ListItem")
                        .HasForeignKey("Cineaste.Core.Domain.ListItem", "LimitedSeriesId");
            ...
            modelBuilder.Entity("Cineaste.Core.Domain.SeasonPoster", b =>
                {
                    b.HasOne("Cineaste.Core.Domain.SeasonPart", "SeasonPart")
                        .WithMany()
                        .HasForeignKey("SeasonPartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SeasonPart");
                });
